...
| `index.html` | Landing page for the published lecture site, linking the seventeen credit lectures. See below |
...
`index.html` at the repository root lists the seventeen credit lectures, each with a one-line
