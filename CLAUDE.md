...
| `index.html` | Landing page for the published lecture site, linking the sixteen credit lectures. See below |
...
`index.html` at the repository root lists the sixteen credit lectures, each with a one-line
