...
| `index.html` | Landing page for the published lecture site, linking the fourteen credit lectures. See below |
...
`index.html` at the repository root lists the fourteen credit lectures, each with a one-line
