...
| `index.html` | Landing page for the published lecture site, linking the eighteen credit lectures. See below |
...
`index.html` at the repository root lists the eighteen credit lectures, each with a one-line
